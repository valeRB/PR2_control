...
##    torque_z = np.array([])
    ...
    return time, force_x, force_y, force_x_t, force_y_t
...
##        r_torque_z = np.linspace(0,100)
        ...
        (r_time, r_force_x, r_force_y, r_force_x_t, r_force_y_t) = read_data(bag, 'r', alpha_r)
        (l_time, l_force_x, l_force_y, l_force_x_t, l_force_y_t) = read_data(bag, 'l', alpha_l)
...
##                         r_torque_y, r_torque_z)= read_data(bag, 'r')
        ...
        figure('Transformation of force X')
        subplot(221)
        ...
        figure('Transformation of force Y')
        subplot(221)
